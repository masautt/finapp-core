...
public class CommonTableSvc<TEntity>(TableCommonRepo repo) where TEntity : class
{
    private readonly TableCommonRepo _repo = repo ?? throw new ArgumentNullException(nameof(repo));
